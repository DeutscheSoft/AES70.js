...
SRC = $(filter-out src/index.browser.js src/utf8_node.js, $(wildcard src/*.js))
...
dist/rollup.js: $(SRC) Makefile config/rollup.conf.js
	$(ROLLUP) --o $@ --f iife -c config/rollup.conf.js src/index.browser.js -m dist/rollup.js.map
