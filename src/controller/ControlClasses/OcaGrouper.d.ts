...
export declare class OcaGrouper extends OcaAgent {
  ...
  /**
   * Adds a target to the group. The return value indicates whether the target
   * was successfully added. This method does not enroll the new target in any
   * of the grouper's groups -- it merely makes the target available for
   * enrollment. Group membership is controlled by the SetEnrollment method,
   * q.v.
   *
