...
export class OcaObservationEventData {
  constructor(Event, Reading) {
     ...
     * @member RemoteControlClasses.OcaObservationEventData#OnEventChanged {PropertyEvent<OcaEvent>} - This event is emitted when Event changes in the remote object.
     */
    this.Event = Event;
    /**
     * The observed value that the event is reporting.
     * @member RemoteControlClasses.OcaObservationEventData#OnReadingChanged {PropertyEvent<float>} - This event is emitted when Reading changes in the remote object.
     */
