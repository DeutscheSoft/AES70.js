...
var f = function(w) {
 ...
 var utf8_to_buffer, buffer_to_utf8, utf8_encoded_length;
 ...
 function signature() {
     ...
     for (i = 0; i < arguments.length; i++) {
         ...
         case "object":
             ...
             break;
         default:
             throw new Error("Bad argument: " + typeof(arguments[i]));
         }
     }
 ...
 var SP = {
     ...
     enum: Enum,
     encoder: encoder,
     utf8_to_buffer: utf8_to_buffer,
     buffer_to_utf8: buffer_to_utf8,
 };
 w.SP = SP;
};
if (module) {
